        ...
        <div className="input-container">
            <div className="left">
                <div className="name-input">
                    ...
                    <div className="first-last-name-container">
                        <div className="first-name">
                            <input type="text" name="first" id="first" required onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{setUserName(e.target.value)}} /><br />
                ...
                <div className="email">
                    ...
                    <input type="email" className="email" name="email" required onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{setUserEmail(e.target.value)}}/>
                </div>
                <div className="topic">
                    <p>Topic <span>*</span></p>
                    <div className="topic-container">
                        ...
                        <div className="general-container">
                            <input type="checkbox" name="general" className="general" value={"general"} checked={radioSelected('general')} onChange={radioHandler}/>
                            <label htmlFor="general">General</label>
                        </div>
                        <div className="bug-container">
                            <input type="checkbox" name="bug" className="bug" value={"bug"} checked={radioSelected('bug')} onChange={radioHandler}/>
            ...
            <div className="right">
                <label htmlFor="desc">Description<span>optional</span></label>
                <textarea name="desc" id="desc" cols={30} rows={17} />
                <button onClick={submitHandler} style={{backgroundColor:bacolor}} disabled={disabled}>SEND</button>
            </div>
        </div> 
    </div>
    );
    ...
    <div className="container-popup">
        <h1>Support Ticket Form</h1>
            <div className="ticket-container">
                ...
                <p>ticket number : <span>{Math.round(Math.random()*1000)}</span></p>
            </div>
    </div>
    )
  }
